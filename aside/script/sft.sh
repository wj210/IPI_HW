...
output_dir="/mnt/disk1/wjyeo/models/" # change to place to store large models
...
export WANDB_PROJECT="MetaSecAlign_DPO" # 1e-6 with beta 0.01 on alpaca

extra_name='MetaSecAlign'
config_path='./configs/qwen/alpaca_vanilla_dpo.json' ## for MetaSecAlign with both alpaca and tool data
